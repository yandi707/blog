            ...
            <div class="row">
                <div class="col-md-4 logo-div">
                    <div class="logo-inner text-center">
                        <div class="logo-name">
                            <a href="index.html">
                                <img src="../static/assets/img/Jennie.jpg" class="img-circle"/>
                            </a>
                        </div>
...
<div class="info-sec">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                Say hello to me at <strong>stephanie_went</strong>@hotmail.com
            </div>
            <div class="col-md-2">
                <div class="social-link">
                    <a href="https://blog.csdn.net/Stephanie17395" class="btn btn-default btn-xs">
                        <i class="fa fa-2x">C</i></a>
                    <a href="https://www.zhihu.com/people/stephanie7396/activities" class="btn btn-default btn-xs">
                        <i class="fa  fa-2x">知</i></a>
                    <a href="https://github.com/StephaineWYT" class="btn btn-default btn-xs">
