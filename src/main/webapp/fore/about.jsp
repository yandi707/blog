            ...
            <div class="col-lg-12">
                <ul class="timeline">
                    ...
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Ningbo Finance and Economy University</h4>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                ...
                                <h4 class="subheading">I Am A Good Girl</h4>
                            </div>
                            <div class="timeline-body">
    ...
    <div class="container">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="col-md-4"><i class="fa fa-map-marker fa-2x"></i>
                <p>浙江省宁波市<br>
                    ${blogger.address}</p><!-- 海曙区 高桥镇 学院路 899号 -->
            </div>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="social">
                <ul>
                    <li><a href="https://blog.csdn.net/Stephanie17395"><i class="fa">C</i></a></li>
                    <li><a href="https://www.zhihu.com/people/stephanie7396/activities"><i class="fa">知</i></a></li>
                    <li><a href="https://github.com/StephaineWYT"><i class="fa fa-github"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
