...
public class CheckController {
    ...
    public boolean checkMail(@RequestBody Blogger blogger) {
        ...
        if (blogger.getEmail().equals(bloggerService.getBloggerEmail())) {
            ...
            //发送人
            props.put("mail.from", "820352756@qq.com");
            ...
            try {
                ...
                mimeMessage.setFrom(new InternetAddress(nickname + "'<" + "820352756@qq.com" + " > '"));

                //第五步：设置接收人信息
                ts.sendMessage(mimeMessage, InternetAddress.parse("820352756@qq.com"));
